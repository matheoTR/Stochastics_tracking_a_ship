...
# 1. Chargement des données [cite: 298]
# Assurez-vous que les fichiers .txt sont dans le même répertoire
...
plt.plot(observations[:, 0], observations[:, 1], 'r.', alpha=0.3, label='Observations Bruyantes')
